...
<body onload="initialize();">
  ...
  <div class="container">
    ...
    <form action="p_addbrand.php" method="post">
      <div class="input-group" style="margin-bottom:10px">
        <span class="input-group-addon"><i class="fa fa-tags"></i> Brand</span>
        <input id="brand" type="text" class="form-control" name="brand" required placeholder="Enter brand">
      </div>
      <div class="input-group" style="margin-bottom:10px">
      ...
      <input type="submit" class="btn btn-primary pull-right" value="Add Brand" />
    </form>
  </div>
