...
<body onload="initialize();">
  ...
  <div class="container">
    ...
    <form action="p_addproduct.php" method="post" enctype="multipart/form-data">
      <div class="input-group" style="margin-bottom:10px">
        <span class="input-group-addon"><i class="fa fa-product-hunt"></i> Product</span>
        <input id="product" type="text" class="form-control" name="product" required placeholder="Enter product">
      </div>
      <div class="input-group" style="margin-bottom:10px">
