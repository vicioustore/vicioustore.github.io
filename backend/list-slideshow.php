...
<body onload="initialize();">
  ...
  <div class="container">
    <button type="button" style="margin-bottom:15px;" class="btn btn-default btn-danger"
      onClick="window.location.href='addslideshow.php'">
      <i class="fa fa-plus-circle" aria-hidden="true"></i> New Slide Show
    </button>
    <br />
    <table class="table table-hover">
      ...
      <tbody>
        <?php
        $hasil_kondisi = mysqli_query($conn, "select * from tblslide");
        $i = 0;
        while ($row = mysqli_fetch_array($hasil_kondisi, MYSQLI_ASSOC)) {
          ...
          <tr>
            ...
            <td><img width="150" height="75" src="../public/images/banner/<?php echo $row['gambar']; ?>" /></td>
            <td><a href="editslideshow.php?s=<?php echo $row['idslide']; ?>" class="btn btn-primary btn-info"
                role="button"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a> | <a
                href="deleteslideshow.php?s=<?php echo $row['idslide']; ?>" class="btn btn-primary btn-info" role="button"
